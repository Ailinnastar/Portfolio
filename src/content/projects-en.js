  ...
  internship: [
    {
      ...
      teaser: 'Market research in East Asia: market features, preferences, and competitor pricing—enabled by cross-country product matching.',
      description: 'We supported a client’s market research in East Asia: understanding market features, customer preferences, and how price and product positioning compare across companies (including competitors). Each market’s sites use different naming rules and product images, so the same item is hard to compare across countries or players. I built a system that matches “product in country A” to “product in country B,” so we could compare like-for-like, feed market features and prices (own and others) into dashboards, and support strategy and pricing decisions.',
      approach: 'I designed a pipeline: scrape and clean product data per market (Python, with encodings and local site structures handled explicitly), then run a matching step that aligns the same product across countries despite different names and images. I used a product key (brand, category, attributes) plus rules and fuzzy matching to link the same SKU across markets. I validated on a small pilot before scaling, then wired the output into Power BI for market features, preferences, and price benchmarks (client and competitors). The goal was a single, comparable view for market research across East Asia.',
      points: [
        'Cross-country product-matching system (same product across different names and images) — ~70% improvement in like-for-like comparison',
        'Python pipelines for multilingual scraping; Power BI for market features, preferences, and price (own and competitor) by market',
        'Market research in East Asia: market features, preferences, and competitor pricing to support strategy',
      ],
    },
    {
    ...
    },
    {
      ...
      description: 'I built and validated analytical models to predict component composition from Raman spectra, reaching ~90% accuracy. The work aligned with the existing data pipeline and produced documented, handover-ready models for the team.',
      approach: 'I mapped the current Raman pipeline and data specs first, then designed component-prediction models with a strict train/validate split and reported accuracy. I kept methodology and assumptions written up so the work could be replicated or extended without me.',
      points: [
