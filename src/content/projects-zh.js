  ...
  internship: [
    {
      ...
      description: '支持客户在东亚开展市场研究：把握市场特征、消费者偏好以及各公司（含竞品）的价格与产品定位差异。各国站点命名与产品图不一致，难以做同品对比。我搭建了「国家 A 商品 ↔ 国家 B 商品」的跨国家同品匹配系统，实现同品可比，将市场特征与价格（自社及他社）接入看板，支持战略与定价决策。',
      approach: '按市场爬取并清洗商品数据（Python，显式处理编码与各国站点结构），再通过匹配步骤在名称与图片不一致的情况下对齐同一商品。用品牌、品类、属性等构成商品键，结合规则与模糊匹配实现跨市场同一 SKU 对应。小范围试点验证后扩展，结果接入 Power BI 呈现市场特征、偏好与价格对标（自社与竞合）。目标是为东亚市场研究提供单一、可比的视图。',
      points: [
        '跨国家同品匹配（不同名称与图片下对应同一商品）— 同品可比准确率约 70% 提升',
        '多语言爬取 Python 流程；市场特征、偏好与价格（自社及竞合）的 Power BI 看板',
        '东亚市场研究：市场特征、偏好与竞合价格以支持战略',
      ],
    },
    {
      title: '电商分析',
